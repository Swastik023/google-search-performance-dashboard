...
export const NOTIFY_L: Record<NotifyLang, Tpl> = {
  en: {
    ...
    digestTitleAll: "📊 RankTracker Console digest — all sites",
    digestTitleTag: tag => `📊 RankTracker Console digest — tag "${tag}"`,
  ...
  ru: {
    ...
    digestTitleAll: "📊 Дайджест RankTracker Console — все сайты",
    digestTitleTag: tag => `📊 Дайджест RankTracker Console — тег «${tag}»`,
  ...
  uk: {
    ...
    digestTitleAll: "📊 Дайджест RankTracker Console — всі сайти",
    digestTitleTag: tag => `📊 Дайджест RankTracker Console — тег «${tag}»`,
  ...
  fr: {
    ...
    digestTitleAll: "📊 Résumé RankTracker Console — tous les sites",
    digestTitleTag: tag => `📊 Résumé RankTracker Console — étiquette « ${tag} »`,
  ...
  es: {
    ...
    digestTitleAll: "📊 Resumen de RankTracker Console — todos los sitios",
    digestTitleTag: tag => `📊 Resumen de RankTracker Console — etiqueta «${tag}»`,
  ...
  de: {
    ...
    digestTitleAll: "📊 RankTracker Console-Übersicht — alle Websites",
    digestTitleTag: tag => `📊 RankTracker Console-Übersicht — Tag „${tag}"`,
  ...
  zh: {
    ...
    digestTitleAll: "📊 RankTracker Console 摘要 —— 全部站点",
    digestTitleTag: tag => `📊 RankTracker Console 摘要 —— 标签「${tag}」`,
